...
public final class BukkitUsageMessageBuilderTest {
    ...
    public void helperClass(){
        String usage = this.bukkitUsageMessageBuilder.build("employees fire", new String[]{"player", "...[reason]¡pordefecto!"}, "/employees help");
        assertEquals(usage, "/employees fire <player> ...[reason] For more information: /employees help");
    }
}
